...
这一节，我们从 环境标准化、k8s 部署、小结 三个方面来学习。
...
实践 2- 生成 10 个随机数保存于数组中，并找出其最大值和最小值
...
if 嵌套 for 语句实践 3- 获取系统支持的 shell 类型
